...
@section('banner')
    <section id="banner" style="padding: 10em 0 3em 0;">
    	<h2>{{$calamity->title}} Project Details</h2>
    </section>
@endsection
	...
	<section id="main" class="wrapper">
		<div class="container">
			<header class="major special">
				<a href="\projects\calamities\{{$calamity->id}}\description" class="button big" style="display: inline; float: right;">Back</a>
				...
				<div class="hide" id="phpLeft">
					...
					<h2 style="display: inline;">Php {{$calamity->goal - $calamity->current}} left to go!</h2>
				</div>
				...
				<div class="hide" id="curOverGoal">
                    ...
                    <progress class="calamityProgress" id="progressBar" max={{$calamity->goal}} value={{$calamity->current}}></progress>
                    <h2 class="calamityProgressAfter"> Php {{$calamity->goal}} </h2>
				</div>
