	...
	<section id="main" class="wrapper">
		<div class="container">
			...
			<header class="major special">
				<h2>{{$calamity->title}}</h2>
				<a href="\projects\calamities\{{$calamity->id}}\donate" class="button special big" style=" float: right;">Donate</a>
				<p>Php {{$calamity->goal - $calamity->current}} left to go!</p>
	            <a href="\projects\calamities\{{$calamity->id}}\edit" class="button big" style="display: inline;">Edit</a>
			</header>


			<header id="userTab" class="alt" style="height: 20em; margin-bottom: 3%;">
			    <nav id="nav">
			    	<img class="image center" src="\images/{{$calamity->image}}.jpg" alt="" style="max-height: 20em; width: auto;" />
			    </nav>
			</header>
			    ...
			    <nav id="nav">
			        <ul>
		            	...
		            	<li id="projDescTab" class={{Request::is('projects/*/description') ? 'current_page_item' : ''}}>
		            		...
		            		<a href="\projects\calamities\{{$calamity->id}}\description">Description</a>
		            	</li>
		            	...
		            	<li id="projUpdateTab" class={{Request::is('projects/*/updates') ? 'current_page_item' : ""}}>
		            		...
		            		<a href="\projects\calamities\{{$calamity->id}}\updates">Updates</a>
		            	</li>
		            	...
		            	<li id="projComntTab" class={{Request::is('projects/*/comments') ? 'current_page_item' : ''}}>
		            		...
		            		<a href="\projects\calamities\{{$calamity->id}}\comments">Comments</a>
		            	</li>
		            	...
		            	<li id="projDntnTab" class={{Request::is('projects/*/donations') ? 'current_page_item' : ''}}>
		            		...
		            		<a href="\projects\calamities\{{$calamity->id}}\donations">Donations</a>
		            	</li>
			        </ul>
			    </nav>
			</header>
